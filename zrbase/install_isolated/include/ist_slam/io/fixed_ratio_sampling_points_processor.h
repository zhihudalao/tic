...
#ifndef IST_SLAM_IO_FIXED_RATIO_SAMPLING_POINTS_PROCESSOR_H_
#define IST_SLAM_IO_FIXED_RATIO_SAMPLING_POINTS_PROCESSOR_H_
...
#endif  // IST_SLAM_IO_FIXED_RATIO_SAMPLING_POINTS_PROCESSOR_H_
