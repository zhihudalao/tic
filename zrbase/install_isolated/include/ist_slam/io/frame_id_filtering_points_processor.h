...
#ifndef IST_SLAM_IO_FRAME_ID_FILTERING_POINTS_PROCESSOR_H_
#define IST_SLAM_IO_FRAME_ID_FILTERING_POINTS_PROCESSOR_H_
...
#endif  // IST_SLAM_IO_FRAME_ID_FILTERING_POINTS_PROCESSOR_H_
