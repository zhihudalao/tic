...
#ifndef IST_SLAM_IO_MIN_MAX_RANGE_FILTERING_POINTS_PROCESSOR_H_
#define IST_SLAM_IO_MIN_MAX_RANGE_FILTERING_POINTS_PROCESSOR_H_
...
#endif  // IST_SLAM_IO_MIN_MAX_RANGE_FILTERING_POINTS_PROCESSOR_H_
