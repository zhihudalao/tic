...
#ifndef IST_SLAM_IO_PROBABILITY_GRID_POINTS_PROCESSOR_H_
#define IST_SLAM_IO_PROBABILITY_GRID_POINTS_PROCESSOR_H_
...
#endif  // IST_SLAM_IO_PROBABILITY_GRID_POINTS_PROCESSOR_H_
