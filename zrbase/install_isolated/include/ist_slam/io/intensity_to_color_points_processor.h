...
#ifndef IST_SLAM_IO_INTENSITY_TO_COLOR_POINTS_PROCESSOR_H_
#define IST_SLAM_IO_INTENSITY_TO_COLOR_POINTS_PROCESSOR_H_
...
#endif  // IST_SLAM_IO_INTENSITY_TO_COLOR_POINTS_PROCESSOR_H_
