...
#ifndef IST_SLAM_IO_COLOR_H_
#define IST_SLAM_IO_COLOR_H_
...
inline uint8 FloatComponentToUint8(float c) {
  return static_cast<uint8>(ist_slam::common::RoundToInt(
      ist_slam::common::Clamp(c, 0.f, 1.f) * 255));
}
