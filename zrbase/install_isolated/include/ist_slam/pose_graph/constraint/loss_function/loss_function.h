...
#ifndef IST_SLAM_POSE_GRAPH_CONSTRAINT_LOSS_FUNCTION_H_
#define IST_SLAM_POSE_GRAPH_CONSTRAINT_LOSS_FUNCTION_H_
...
#endif  // IST_SLAM_POSE_GRAPH_CONSTRAINT_LOSS_FUNCTION_H_
