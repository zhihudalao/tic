...
#ifndef IST_SLAM_POSE_GRAPH_CONSTRAINT_CONSTRAINT_UTILS_H_
#define IST_SLAM_POSE_GRAPH_CONSTRAINT_CONSTRAINT_UTILS_H_

#include "ist_slam/common/utils.h"
...
#endif  // IST_SLAM_POSE_GRAPH_CONSTRAINT_CONSTRAINT_UTILS_H_
