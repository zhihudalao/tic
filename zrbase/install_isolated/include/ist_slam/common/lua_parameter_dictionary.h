...
#ifndef IST_SLAM_COMMON_LUA_PARAMETER_DICTIONARY_H_
#define IST_SLAM_COMMON_LUA_PARAMETER_DICTIONARY_H_
...
#endif  // IST_SLAM_COMMON_LUA_PARAMETER_DICTIONARY_H_
