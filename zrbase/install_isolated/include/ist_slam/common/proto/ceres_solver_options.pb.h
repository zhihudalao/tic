...
// source: ist_slam/common/proto/ceres_solver_options.proto

#ifndef PROTOBUF_ist_5fslam_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto {
...
class CeresSolverOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.common.proto.CeresSolverOptions) */ {
 public:
  CeresSolverOptions();
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.common.proto.CeresSolverOptions)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
inline bool CeresSolverOptions::use_nonmonotonic_steps() const {
  // @@protoc_insertion_point(field_get:ist_slam.common.proto.CeresSolverOptions.use_nonmonotonic_steps)
...
inline void CeresSolverOptions::set_use_nonmonotonic_steps(bool value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.common.proto.CeresSolverOptions.use_nonmonotonic_steps)
}
...
inline ::google::protobuf::int32 CeresSolverOptions::max_num_iterations() const {
  // @@protoc_insertion_point(field_get:ist_slam.common.proto.CeresSolverOptions.max_num_iterations)
...
inline void CeresSolverOptions::set_max_num_iterations(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.common.proto.CeresSolverOptions.max_num_iterations)
}
...
inline ::google::protobuf::int32 CeresSolverOptions::num_threads() const {
  // @@protoc_insertion_point(field_get:ist_slam.common.proto.CeresSolverOptions.num_threads)
  return num_threads_;
}
inline void CeresSolverOptions::set_num_threads(::google::protobuf::int32 value) {
  
  num_threads_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.common.proto.CeresSolverOptions.num_threads)
}
...
#endif  // PROTOBUF_ist_5fslam_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto__INCLUDED
