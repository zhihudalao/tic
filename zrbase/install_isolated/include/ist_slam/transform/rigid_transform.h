...
#ifndef IST_SLAM_TRANSFORM_RIGID_TRANSFORM_H_
#define IST_SLAM_TRANSFORM_RIGID_TRANSFORM_H_
...
std::ostream& operator<<(std::ostream& os,
                         const ist_slam::transform::Rigid2<T>& rigid) {
...
template <typename T>
std::ostream& operator<<(std::ostream& os,
                         const ist_slam::transform::Rigid3<T>& rigid) {
  os << rigid.DebugString();
  return os;
}
...
#endif  // IST_SLAM_TRANSFORM_RIGID_TRANSFORM_H_
