...
// source: ist_slam/sensor/proto/adaptive_voxel_filter_options.proto

#ifndef PROTOBUF_ist_5fslam_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto {
...
class AdaptiveVoxelFilterOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
inline float AdaptiveVoxelFilterOptions::max_length() const {
  // @@protoc_insertion_point(field_get:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions.max_length)
  return max_length_;
}
inline void AdaptiveVoxelFilterOptions::set_max_length(float value) {
  
  max_length_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions.max_length)
}
...
inline float AdaptiveVoxelFilterOptions::min_num_points() const {
  // @@protoc_insertion_point(field_get:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions.min_num_points)
  return min_num_points_;
}
inline void AdaptiveVoxelFilterOptions::set_min_num_points(float value) {
  
  min_num_points_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions.min_num_points)
}
...
inline float AdaptiveVoxelFilterOptions::max_range() const {
  // @@protoc_insertion_point(field_get:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions.max_range)
  return max_range_;
}
inline void AdaptiveVoxelFilterOptions::set_max_range(float value) {
  
  max_range_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.sensor.proto.AdaptiveVoxelFilterOptions.max_range)
}
...
#endif  // PROTOBUF_ist_5fslam_2fsensor_2fproto_2fadaptive_5fvoxel_5ffilter_5foptions_2eproto__INCLUDED
