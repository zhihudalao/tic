...
// source: ist_slam/mapping/proto/scan_matching/real_time_correlative_scan_matcher_options.proto

#ifndef PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto {
...
class RealTimeCorrelativeScanMatcherOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
inline double RealTimeCorrelativeScanMatcherOptions::linear_search_window() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.linear_search_window)
...
inline void RealTimeCorrelativeScanMatcherOptions::set_linear_search_window(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.linear_search_window)
}
...
inline double RealTimeCorrelativeScanMatcherOptions::angular_search_window() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.angular_search_window)
...
inline void RealTimeCorrelativeScanMatcherOptions::set_angular_search_window(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.angular_search_window)
}
...
inline double RealTimeCorrelativeScanMatcherOptions::translation_delta_cost_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.translation_delta_cost_weight)
...
inline void RealTimeCorrelativeScanMatcherOptions::set_translation_delta_cost_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.translation_delta_cost_weight)
}
...
inline double RealTimeCorrelativeScanMatcherOptions::rotation_delta_cost_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.rotation_delta_cost_weight)
...
inline void RealTimeCorrelativeScanMatcherOptions::set_rotation_delta_cost_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.RealTimeCorrelativeScanMatcherOptions.rotation_delta_cost_weight)
}
...
#endif  // PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2freal_5ftime_5fcorrelative_5fscan_5fmatcher_5foptions_2eproto__INCLUDED
