...
// source: ist_slam/mapping/proto/scan_matching/ceres_scan_matcher_options_2d.proto

#ifndef PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto {
...
class CeresScanMatcherOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D) */ {
 public:
  ...
  // .ist_slam.common.proto.CeresSolverOptions ceres_solver_options = 9;
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto::TableStruct;
};
// ===================================================================
...
inline double CeresScanMatcherOptions2D::occupied_space_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.occupied_space_weight)
...
inline void CeresScanMatcherOptions2D::set_occupied_space_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.occupied_space_weight)
}
...
inline double CeresScanMatcherOptions2D::translation_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.translation_weight)
...
inline void CeresScanMatcherOptions2D::set_translation_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.translation_weight)
}
...
inline double CeresScanMatcherOptions2D::rotation_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.rotation_weight)
  return rotation_weight_;
}
inline void CeresScanMatcherOptions2D::set_rotation_weight(double value) {
  
  rotation_weight_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.rotation_weight)
}
...
inline const ::ist_slam::common::proto::CeresSolverOptions& CeresScanMatcherOptions2D::ceres_solver_options() const {
  const ::ist_slam::common::proto::CeresSolverOptions* p = ceres_solver_options_;
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.ceres_solver_options)
...
inline ::ist_slam::common::proto::CeresSolverOptions* CeresScanMatcherOptions2D::mutable_ceres_solver_options() {
  
  if (ceres_solver_options_ == NULL) {
    ceres_solver_options_ = new ::ist_slam::common::proto::CeresSolverOptions;
  }
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.ceres_solver_options)
  return ceres_solver_options_;
}
inline ::ist_slam::common::proto::CeresSolverOptions* CeresScanMatcherOptions2D::release_ceres_solver_options() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.ceres_solver_options)
  
  ::ist_slam::common::proto::CeresSolverOptions* temp = ceres_solver_options_;
  ceres_solver_options_ = NULL;
  return temp;
}
inline void CeresScanMatcherOptions2D::set_allocated_ceres_solver_options(::ist_slam::common::proto::CeresSolverOptions* ceres_solver_options) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions2D.ceres_solver_options)
}
...
#endif  // PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f2d_2eproto__INCLUDED
