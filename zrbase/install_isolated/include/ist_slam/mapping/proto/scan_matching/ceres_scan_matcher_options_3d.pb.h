...
// source: ist_slam/mapping/proto/scan_matching/ceres_scan_matcher_options_3d.proto

#ifndef PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto {
...
class CeresScanMatcherOptions3D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D) */ {
 public:
  ...
  // .ist_slam.common.proto.CeresSolverOptions ceres_solver_options = 6;
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto::TableStruct;
};
// ===================================================================
...
inline double CeresScanMatcherOptions3D::occupied_space_weight(int index) const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.occupied_space_weight)
...
inline void CeresScanMatcherOptions3D::set_occupied_space_weight(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.occupied_space_weight)
}
inline void CeresScanMatcherOptions3D::add_occupied_space_weight(double value) {
  occupied_space_weight_.Add(value);
  // @@protoc_insertion_point(field_add:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.occupied_space_weight)
}
inline const ::google::protobuf::RepeatedField< double >&
CeresScanMatcherOptions3D::occupied_space_weight() const {
  // @@protoc_insertion_point(field_list:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.occupied_space_weight)
  return occupied_space_weight_;
}
inline ::google::protobuf::RepeatedField< double >*
CeresScanMatcherOptions3D::mutable_occupied_space_weight() {
  // @@protoc_insertion_point(field_mutable_list:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.occupied_space_weight)
  return &occupied_space_weight_;
}
...
inline double CeresScanMatcherOptions3D::translation_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.translation_weight)
...
inline void CeresScanMatcherOptions3D::set_translation_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.translation_weight)
}
...
inline double CeresScanMatcherOptions3D::rotation_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.rotation_weight)
  return rotation_weight_;
}
inline void CeresScanMatcherOptions3D::set_rotation_weight(double value) {
  
  rotation_weight_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.rotation_weight)
}
...
inline bool CeresScanMatcherOptions3D::only_optimize_yaw() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.only_optimize_yaw)
  return only_optimize_yaw_;
}
inline void CeresScanMatcherOptions3D::set_only_optimize_yaw(bool value) {
  
  only_optimize_yaw_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.only_optimize_yaw)
}
...
inline const ::ist_slam::common::proto::CeresSolverOptions& CeresScanMatcherOptions3D::ceres_solver_options() const {
  const ::ist_slam::common::proto::CeresSolverOptions* p = ceres_solver_options_;
  // @@protoc_insertion_point(field_get:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.ceres_solver_options)
...
inline ::ist_slam::common::proto::CeresSolverOptions* CeresScanMatcherOptions3D::mutable_ceres_solver_options() {
  
  if (ceres_solver_options_ == NULL) {
    ceres_solver_options_ = new ::ist_slam::common::proto::CeresSolverOptions;
  }
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.ceres_solver_options)
  return ceres_solver_options_;
}
inline ::ist_slam::common::proto::CeresSolverOptions* CeresScanMatcherOptions3D::release_ceres_solver_options() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.ceres_solver_options)
  
  ::ist_slam::common::proto::CeresSolverOptions* temp = ceres_solver_options_;
  ceres_solver_options_ = NULL;
  return temp;
}
inline void CeresScanMatcherOptions3D::set_allocated_ceres_solver_options(::ist_slam::common::proto::CeresSolverOptions* ceres_solver_options) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.scan_matching.proto.CeresScanMatcherOptions3D.ceres_solver_options)
}
...
#endif  // PROTOBUF_ist_5fslam_2fmapping_2fproto_2fscan_5fmatching_2fceres_5fscan_5fmatcher_5foptions_5f3d_2eproto__INCLUDED
