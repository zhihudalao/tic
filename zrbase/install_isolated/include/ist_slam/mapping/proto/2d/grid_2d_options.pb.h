...
// source: ist_slam/mapping/proto/2d/grid_2d_options.proto

#ifndef PROTOBUF_ist_5fslam_2fmapping_2fproto_2f2d_2fgrid_5f2d_5foptions_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fmapping_2fproto_2f2d_2fgrid_5f2d_5foptions_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fmapping_2fproto_2f2d_2fgrid_5f2d_5foptions_2eproto {
...
class GridOptions2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.GridOptions2D) */ {
 public:
  GridOptions2D();
  ...
  // .ist_slam.mapping.proto.GridOptions2D.GridType grid_type = 1;
  void clear_grid_type();
  static const int kGridTypeFieldNumber = 1;
  ::ist_slam::mapping::proto::GridOptions2D_GridType grid_type() const;
  void set_grid_type(::ist_slam::mapping::proto::GridOptions2D_GridType value);
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.GridOptions2D)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2f2d_2fgrid_5f2d_5foptions_2eproto::TableStruct;
};
// ===================================================================
...
inline ::ist_slam::mapping::proto::GridOptions2D_GridType GridOptions2D::grid_type() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.GridOptions2D.grid_type)
  return static_cast< ::ist_slam::mapping::proto::GridOptions2D_GridType >(grid_type_);
}
inline void GridOptions2D::set_grid_type(::ist_slam::mapping::proto::GridOptions2D_GridType value) {
  
  grid_type_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.GridOptions2D.grid_type)
}
...
inline float GridOptions2D::resolution() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.GridOptions2D.resolution)
  return resolution_;
}
inline void GridOptions2D::set_resolution(float value) {
  
  resolution_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.GridOptions2D.resolution)
}
...
template <> struct is_proto_enum< ::ist_slam::mapping::proto::GridOptions2D_GridType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ist_slam::mapping::proto::GridOptions2D_GridType>() {
  return ::ist_slam::mapping::proto::GridOptions2D_GridType_descriptor();
}
...
#endif  // PROTOBUF_ist_5fslam_2fmapping_2fproto_2f2d_2fgrid_5f2d_5foptions_2eproto__INCLUDED
