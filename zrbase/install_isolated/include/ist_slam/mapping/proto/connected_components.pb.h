...
// source: ist_slam/mapping/proto/connected_components.proto

#ifndef PROTOBUF_ist_5fslam_2fmapping_2fproto_2fconnected_5fcomponents_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fmapping_2fproto_2fconnected_5fcomponents_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fmapping_2fproto_2fconnected_5fcomponents_2eproto {
...
class ConnectedComponents_ConnectedComponent : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2fconnected_5fcomponents_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class ConnectedComponents : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.ConnectedComponents) */ {
 public:
  ConnectedComponents();
  ...
  // repeated .ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent connected_component = 1;
  int connected_component_size() const;
  void clear_connected_component();
  static const int kConnectedComponentFieldNumber = 1;
  const ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent& connected_component(int index) const;
  ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent* mutable_connected_component(int index);
  ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent* add_connected_component();
  ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent >*
      mutable_connected_component();
  const ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent >&
      connected_component() const;

  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.ConnectedComponents)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent > connected_component_;
  mutable int _cached_size_;
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2fconnected_5fcomponents_2eproto::TableStruct;
};
// ===================================================================
...
inline ::google::protobuf::int32 ConnectedComponents_ConnectedComponent::trajectory_id(int index) const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent.trajectory_id)
...
inline void ConnectedComponents_ConnectedComponent::set_trajectory_id(int index, ::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent.trajectory_id)
}
inline void ConnectedComponents_ConnectedComponent::add_trajectory_id(::google::protobuf::int32 value) {
  trajectory_id_.Add(value);
  // @@protoc_insertion_point(field_add:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent.trajectory_id)
}
inline const ::google::protobuf::RepeatedField< ::google::protobuf::int32 >&
ConnectedComponents_ConnectedComponent::trajectory_id() const {
  // @@protoc_insertion_point(field_list:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent.trajectory_id)
  return trajectory_id_;
}
inline ::google::protobuf::RepeatedField< ::google::protobuf::int32 >*
ConnectedComponents_ConnectedComponent::mutable_trajectory_id() {
  // @@protoc_insertion_point(field_mutable_list:ist_slam.mapping.proto.ConnectedComponents.ConnectedComponent.trajectory_id)
  return &trajectory_id_;
}
...
inline const ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent& ConnectedComponents::connected_component(int index) const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.ConnectedComponents.connected_component)
  return connected_component_.Get(index);
}
inline ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent* ConnectedComponents::mutable_connected_component(int index) {
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.ConnectedComponents.connected_component)
  return connected_component_.Mutable(index);
}
inline ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent* ConnectedComponents::add_connected_component() {
  // @@protoc_insertion_point(field_add:ist_slam.mapping.proto.ConnectedComponents.connected_component)
  return connected_component_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent >*
ConnectedComponents::mutable_connected_component() {
  // @@protoc_insertion_point(field_mutable_list:ist_slam.mapping.proto.ConnectedComponents.connected_component)
  return &connected_component_;
}
inline const ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::ConnectedComponents_ConnectedComponent >&
ConnectedComponents::connected_component() const {
  // @@protoc_insertion_point(field_list:ist_slam.mapping.proto.ConnectedComponents.connected_component)
  return connected_component_;
}
...
#endif  // PROTOBUF_ist_5fslam_2fmapping_2fproto_2fconnected_5fcomponents_2eproto__INCLUDED
