...
// source: ist_slam/mapping/proto/pose_graph.proto

#ifndef PROTOBUF_ist_5fslam_2fmapping_2fproto_2fpose_5fgraph_2eproto__INCLUDED
#define PROTOBUF_ist_5fslam_2fmapping_2fproto_2fpose_5fgraph_2eproto__INCLUDED
...
namespace protobuf_ist_5fslam_2fmapping_2fproto_2fpose_5fgraph_2eproto {
...
class SubmapId : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.SubmapId) */ {
 public:
  SubmapId();
  virtual ~SubmapId();
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.SubmapId)
 private:
  ...
  friend struct protobuf_ist_5fslam_2fmapping_2fproto_2fpose_5fgraph_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class NodeId : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.NodeId) */ {
 public:
  NodeId();
  virtual ~NodeId();
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.NodeId)
 private:
...
class PoseGraph_Constraint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.PoseGraph.Constraint) */ {
 public:
  ...
  // .ist_slam.mapping.proto.NodeId node_id = 2;
  ...
  // .ist_slam.transform.proto.Rigid3d relative_pose = 3;
  ...
  // .ist_slam.mapping.proto.PoseGraph.Constraint.Tag tag = 5;
  void clear_tag();
  static const int kTagFieldNumber = 5;
  ::ist_slam::mapping::proto::PoseGraph_Constraint_Tag tag() const;
  void set_tag(::ist_slam::mapping::proto::PoseGraph_Constraint_Tag value);

  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.PoseGraph.Constraint)
 private:
...
class PoseGraph_LandmarkPose : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.PoseGraph.LandmarkPose) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.PoseGraph.LandmarkPose)
 private:
...
class PoseGraph : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ist_slam.mapping.proto.PoseGraph) */ {
 public:
  PoseGraph();
  virtual ~PoseGraph();
  ...
  // repeated .ist_slam.mapping.proto.PoseGraph.Constraint constraint = 2;
  int constraint_size() const;
  void clear_constraint();
  static const int kConstraintFieldNumber = 2;
  const ::ist_slam::mapping::proto::PoseGraph_Constraint& constraint(int index) const;
  ::ist_slam::mapping::proto::PoseGraph_Constraint* mutable_constraint(int index);
  ::ist_slam::mapping::proto::PoseGraph_Constraint* add_constraint();
  ...
  // repeated .ist_slam.mapping.proto.Trajectory trajectory = 4;
  int trajectory_size() const;
  void clear_trajectory();
  static const int kTrajectoryFieldNumber = 4;
  const ::ist_slam::mapping::proto::Trajectory& trajectory(int index) const;
  ::ist_slam::mapping::proto::Trajectory* mutable_trajectory(int index);
  ::ist_slam::mapping::proto::Trajectory* add_trajectory();
  ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::Trajectory >*
      mutable_trajectory();
  const ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::Trajectory >&
      trajectory() const;

  // repeated .ist_slam.mapping.proto.PoseGraph.LandmarkPose landmark_poses = 5;
  ...
  // @@protoc_insertion_point(class_scope:ist_slam.mapping.proto.PoseGraph)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::PoseGraph_Constraint > constraint_;
  ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::Trajectory > trajectory_;
...
inline ::google::protobuf::int32 SubmapId::trajectory_id() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.SubmapId.trajectory_id)
  return trajectory_id_;
}
inline void SubmapId::set_trajectory_id(::google::protobuf::int32 value) {
  
  trajectory_id_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.SubmapId.trajectory_id)
}
...
inline ::google::protobuf::int32 SubmapId::submap_index() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.SubmapId.submap_index)
  return submap_index_;
}
inline void SubmapId::set_submap_index(::google::protobuf::int32 value) {
  
  submap_index_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.SubmapId.submap_index)
}
...
inline ::google::protobuf::int32 NodeId::trajectory_id() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.NodeId.trajectory_id)
  return trajectory_id_;
}
inline void NodeId::set_trajectory_id(::google::protobuf::int32 value) {
  
  trajectory_id_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.NodeId.trajectory_id)
}
...
inline ::google::protobuf::int32 NodeId::node_index() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.NodeId.node_index)
  return node_index_;
}
inline void NodeId::set_node_index(::google::protobuf::int32 value) {
  
  node_index_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.NodeId.node_index)
}
...
inline const ::ist_slam::mapping::proto::SubmapId& PoseGraph_Constraint::submap_id() const {
  const ::ist_slam::mapping::proto::SubmapId* p = submap_id_;
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.Constraint.submap_id)
  return p != NULL ? *p : *reinterpret_cast<const ::ist_slam::mapping::proto::SubmapId*>(
      &::ist_slam::mapping::proto::_SubmapId_default_instance_);
}
inline ::ist_slam::mapping::proto::SubmapId* PoseGraph_Constraint::mutable_submap_id() {
  
  if (submap_id_ == NULL) {
    submap_id_ = new ::ist_slam::mapping::proto::SubmapId;
  }
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.Constraint.submap_id)
  return submap_id_;
}
inline ::ist_slam::mapping::proto::SubmapId* PoseGraph_Constraint::release_submap_id() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.proto.PoseGraph.Constraint.submap_id)
  
  ::ist_slam::mapping::proto::SubmapId* temp = submap_id_;
  submap_id_ = NULL;
  return temp;
}
inline void PoseGraph_Constraint::set_allocated_submap_id(::ist_slam::mapping::proto::SubmapId* submap_id) {
  delete submap_id_;
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.proto.PoseGraph.Constraint.submap_id)
}
...
inline const ::ist_slam::mapping::proto::NodeId& PoseGraph_Constraint::node_id() const {
  const ::ist_slam::mapping::proto::NodeId* p = node_id_;
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.Constraint.node_id)
  return p != NULL ? *p : *reinterpret_cast<const ::ist_slam::mapping::proto::NodeId*>(
      &::ist_slam::mapping::proto::_NodeId_default_instance_);
}
inline ::ist_slam::mapping::proto::NodeId* PoseGraph_Constraint::mutable_node_id() {
  
  if (node_id_ == NULL) {
    node_id_ = new ::ist_slam::mapping::proto::NodeId;
  }
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.Constraint.node_id)
  return node_id_;
}
inline ::ist_slam::mapping::proto::NodeId* PoseGraph_Constraint::release_node_id() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.proto.PoseGraph.Constraint.node_id)
  
  ::ist_slam::mapping::proto::NodeId* temp = node_id_;
  node_id_ = NULL;
  return temp;
}
inline void PoseGraph_Constraint::set_allocated_node_id(::ist_slam::mapping::proto::NodeId* node_id) {
  delete node_id_;
  node_id_ = node_id;
  if (node_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.proto.PoseGraph.Constraint.node_id)
}
...
inline const ::ist_slam::transform::proto::Rigid3d& PoseGraph_Constraint::relative_pose() const {
  const ::ist_slam::transform::proto::Rigid3d* p = relative_pose_;
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.Constraint.relative_pose)
...
inline ::ist_slam::transform::proto::Rigid3d* PoseGraph_Constraint::mutable_relative_pose() {
  
  if (relative_pose_ == NULL) {
    relative_pose_ = new ::ist_slam::transform::proto::Rigid3d;
  }
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.Constraint.relative_pose)
  return relative_pose_;
}
inline ::ist_slam::transform::proto::Rigid3d* PoseGraph_Constraint::release_relative_pose() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.proto.PoseGraph.Constraint.relative_pose)
  
  ::ist_slam::transform::proto::Rigid3d* temp = relative_pose_;
  relative_pose_ = NULL;
  return temp;
}
inline void PoseGraph_Constraint::set_allocated_relative_pose(::ist_slam::transform::proto::Rigid3d* relative_pose) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.proto.PoseGraph.Constraint.relative_pose)
}
...
inline double PoseGraph_Constraint::translation_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.Constraint.translation_weight)
  return translation_weight_;
}
inline void PoseGraph_Constraint::set_translation_weight(double value) {
  
  translation_weight_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.PoseGraph.Constraint.translation_weight)
}
...
inline double PoseGraph_Constraint::rotation_weight() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.Constraint.rotation_weight)
  return rotation_weight_;
}
inline void PoseGraph_Constraint::set_rotation_weight(double value) {
  
  rotation_weight_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.PoseGraph.Constraint.rotation_weight)
}
...
inline ::ist_slam::mapping::proto::PoseGraph_Constraint_Tag PoseGraph_Constraint::tag() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.Constraint.tag)
  return static_cast< ::ist_slam::mapping::proto::PoseGraph_Constraint_Tag >(tag_);
}
inline void PoseGraph_Constraint::set_tag(::ist_slam::mapping::proto::PoseGraph_Constraint_Tag value) {
  
  tag_ = value;
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.PoseGraph.Constraint.tag)
}
...
inline const ::std::string& PoseGraph_LandmarkPose::landmark_id() const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
...
inline void PoseGraph_LandmarkPose::set_landmark_id(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
}
#if LANG_CXX11
inline void PoseGraph_LandmarkPose::set_landmark_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
}
#endif
inline void PoseGraph_LandmarkPose::set_landmark_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
}
inline void PoseGraph_LandmarkPose::set_landmark_id(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
}
inline ::std::string* PoseGraph_LandmarkPose::mutable_landmark_id() {
  
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
...
inline ::std::string* PoseGraph_LandmarkPose::release_landmark_id() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
...
inline void PoseGraph_LandmarkPose::set_allocated_landmark_id(::std::string* landmark_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.proto.PoseGraph.LandmarkPose.landmark_id)
}
...
inline const ::ist_slam::transform::proto::Rigid3d& PoseGraph_LandmarkPose::global_pose() const {
  const ::ist_slam::transform::proto::Rigid3d* p = global_pose_;
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.LandmarkPose.global_pose)
  return p != NULL ? *p : *reinterpret_cast<const ::ist_slam::transform::proto::Rigid3d*>(
      &::ist_slam::transform::proto::_Rigid3d_default_instance_);
}
inline ::ist_slam::transform::proto::Rigid3d* PoseGraph_LandmarkPose::mutable_global_pose() {
  
  if (global_pose_ == NULL) {
    global_pose_ = new ::ist_slam::transform::proto::Rigid3d;
  }
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.LandmarkPose.global_pose)
  return global_pose_;
}
inline ::ist_slam::transform::proto::Rigid3d* PoseGraph_LandmarkPose::release_global_pose() {
  // @@protoc_insertion_point(field_release:ist_slam.mapping.proto.PoseGraph.LandmarkPose.global_pose)
  
  ::ist_slam::transform::proto::Rigid3d* temp = global_pose_;
  global_pose_ = NULL;
  return temp;
}
inline void PoseGraph_LandmarkPose::set_allocated_global_pose(::ist_slam::transform::proto::Rigid3d* global_pose) {
  delete global_pose_;
  ...
  // @@protoc_insertion_point(field_set_allocated:ist_slam.mapping.proto.PoseGraph.LandmarkPose.global_pose)
}
...
inline const ::ist_slam::mapping::proto::PoseGraph_Constraint& PoseGraph::constraint(int index) const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.constraint)
  return constraint_.Get(index);
}
inline ::ist_slam::mapping::proto::PoseGraph_Constraint* PoseGraph::mutable_constraint(int index) {
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.constraint)
  return constraint_.Mutable(index);
}
inline ::ist_slam::mapping::proto::PoseGraph_Constraint* PoseGraph::add_constraint() {
  // @@protoc_insertion_point(field_add:ist_slam.mapping.proto.PoseGraph.constraint)
...
PoseGraph::mutable_constraint() {
  // @@protoc_insertion_point(field_mutable_list:ist_slam.mapping.proto.PoseGraph.constraint)
  return &constraint_;
}
inline const ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::PoseGraph_Constraint >&
PoseGraph::constraint() const {
  // @@protoc_insertion_point(field_list:ist_slam.mapping.proto.PoseGraph.constraint)
  return constraint_;
}
...
inline const ::ist_slam::mapping::proto::Trajectory& PoseGraph::trajectory(int index) const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.trajectory)
  return trajectory_.Get(index);
}
inline ::ist_slam::mapping::proto::Trajectory* PoseGraph::mutable_trajectory(int index) {
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.trajectory)
  return trajectory_.Mutable(index);
}
inline ::ist_slam::mapping::proto::Trajectory* PoseGraph::add_trajectory() {
  // @@protoc_insertion_point(field_add:ist_slam.mapping.proto.PoseGraph.trajectory)
  return trajectory_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::Trajectory >*
PoseGraph::mutable_trajectory() {
  // @@protoc_insertion_point(field_mutable_list:ist_slam.mapping.proto.PoseGraph.trajectory)
  return &trajectory_;
}
inline const ::google::protobuf::RepeatedPtrField< ::ist_slam::mapping::proto::Trajectory >&
PoseGraph::trajectory() const {
  // @@protoc_insertion_point(field_list:ist_slam.mapping.proto.PoseGraph.trajectory)
  return trajectory_;
}
...
inline const ::ist_slam::mapping::proto::PoseGraph_LandmarkPose& PoseGraph::landmark_poses(int index) const {
  // @@protoc_insertion_point(field_get:ist_slam.mapping.proto.PoseGraph.landmark_poses)
  return landmark_poses_.Get(index);
}
inline ::ist_slam::mapping::proto::PoseGraph_LandmarkPose* PoseGraph::mutable_landmark_poses(int index) {
  // @@protoc_insertion_point(field_mutable:ist_slam.mapping.proto.PoseGraph.landmark_poses)
  return landmark_poses_.Mutable(index);
}
inline ::ist_slam::mapping::proto::PoseGraph_LandmarkPose* PoseGraph::add_landmark_poses() {
  // @@protoc_insertion_point(field_add:ist_slam.mapping.proto.PoseGraph.landmark_poses)
...
PoseGraph::mutable_landmark_poses() {
  // @@protoc_insertion_point(field_mutable_list:ist_slam.mapping.proto.PoseGraph.landmark_poses)
...
PoseGraph::landmark_poses() const {
  // @@protoc_insertion_point(field_list:ist_slam.mapping.proto.PoseGraph.landmark_poses)
  return landmark_poses_;
}
...
template <> struct is_proto_enum< ::ist_slam::mapping::proto::PoseGraph_Constraint_Tag> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ist_slam::mapping::proto::PoseGraph_Constraint_Tag>() {
  return ::ist_slam::mapping::proto::PoseGraph_Constraint_Tag_descriptor();
}
...
#endif  // PROTOBUF_ist_5fslam_2fmapping_2fproto_2fpose_5fgraph_2eproto__INCLUDED
