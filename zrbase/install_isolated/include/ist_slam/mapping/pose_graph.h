...
#ifndef IST_SLAM_MAPPING_POSE_GRAPH_H_
#define IST_SLAM_MAPPING_POSE_GRAPH_H_
...
#include "ist_slam/mapping/pose_graph_trimmer.h"
...
#include "ist_slam/mapping/trajectory_node.h"
#include "ist_slam/sensor/fixed_frame_pose_data.h"
#include "ist_slam/sensor/imu_data.h"
#include "ist_slam/sensor/landmark_data.h"
#include "ist_slam/sensor/map_by_time.h"
...
std::vector<PoseGraph::Constraint> FromProto(
    const ::google::protobuf::RepeatedPtrField<
        ::ist_slam::mapping::proto::PoseGraph::Constraint>&
        constraint_protos);
...
#endif  // IST_SLAM_MAPPING_POSE_GRAPH_H_
