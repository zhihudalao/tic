...
#ifndef IST_SLAM_ROS_IST_SLAM_ROS_NODE_H
#define IST_SLAM_ROS_IST_SLAM_ROS_NODE_H
...
#include "ist_slam/common/fixed_ratio_sampler.h"
#include "ist_slam/mapping/map_builder_interface.h"
#include "ist_slam/mapping/pose_extrapolator.h"
#include "ist_slam_ros/map_builder_bridge.h"
#include "ist_slam_ros/metrics/family_factory.h"
#include "ist_slam_ros/node_constants.h"
#include "ist_slam_ros/node_options.h"
#include "ist_slam_ros/trajectory_options.h"
#include "ist_slam_ros_msgs/FinishTrajectory.h"
#include "ist_slam_ros_msgs/GetTrajectoryStates.h"
#include "ist_slam_ros_msgs/ReadMetrics.h"
#include "ist_slam_ros_msgs/SensorTopics.h"
#include "ist_slam_ros_msgs/StartTrajectory.h"
...
#include "ist_slam_ros_msgs/WriteState.h"
...
class Node {
 public:
  ...
  std::vector<
      std::set<::ist_slam::mapping::TrajectoryBuilderInterface::SensorId>>
 ...
 private:
  ...
  bool HandleStartTrajectory(
      ist_slam_ros_msgs::StartTrajectory::Request& request,
      ist_slam_ros_msgs::StartTrajectory::Response& response);
  bool HandleFinishTrajectory(
      ist_slam_ros_msgs::FinishTrajectory::Request& request,
      ist_slam_ros_msgs::FinishTrajectory::Response& response);
  bool HandleWriteState(ist_slam_ros_msgs::WriteState::Request& request,
                        ist_slam_ros_msgs::WriteState::Response& response);
  bool HandleGetTrajectoryStates(
      ::ist_slam_ros_msgs::GetTrajectoryStates::Request& request,
      ::ist_slam_ros_msgs::GetTrajectoryStates::Response& response);
  bool HandleReadMetrics(
      ist_slam_ros_msgs::ReadMetrics::Request& request,
      ist_slam_ros_msgs::ReadMetrics::Response& response);
  ...
  ComputeExpectedSensorIds(
      const TrajectoryOptions& options,
      const ist_slam_ros_msgs::SensorTopics& topics) const;
  int AddTrajectory(const TrajectoryOptions& options,
                    const ist_slam_ros_msgs::SensorTopics& topics);
  ...
  bool ValidateTopicNames(const ::ist_slam_ros_msgs::SensorTopics& topics,
                          const TrajectoryOptions& options);
  ist_slam_ros_msgs::StatusResponse FinishTrajectoryUnderLock(
  ...
  struct TrajectorySensorSamplers {
    ...
    ::ist_slam::common::FixedRatioSampler rangefinder_sampler;
    ::ist_slam::common::FixedRatioSampler odometry_sampler;
    ::ist_slam::common::FixedRatioSampler fixed_frame_pose_sampler;
    ::ist_slam::common::FixedRatioSampler imu_sampler;
    ::ist_slam::common::FixedRatioSampler landmark_sampler;
  };

  // These are keyed with 'trajectory_id'.
  std::map<int, ::ist_slam::mapping::PoseExtrapolator> extrapolators_;
  ...
  std::unique_ptr<ist_slam_ros::metrics::FamilyFactory> metrics_registry_;
};

}  // namespace ist_slam_ros

#endif  // IST_SLAM_ROS_IST_SLAM_ROS_NODE_H
