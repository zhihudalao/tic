...
#ifndef IST_SLAM_ROS_IST_SLAM_ROS_PLAYABLE_BAG_H
#define IST_SLAM_ROS_IST_SLAM_ROS_PLAYABLE_BAG_H
#include <functional>
#include <queue>

#include <ist_slam_ros_msgs/BagfileProgress.h>
...
class PlayableBag {
 public:
  ...
  rosbag::MessageInstance GetNextMessage(
      ist_slam_ros_msgs::BagfileProgress* progress);
...
#endif  // IST_SLAM_ROS_IST_SLAM_ROS_PLAYABLE_BAG_H
