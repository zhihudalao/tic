...
#ifndef IST_SLAM_ROS_METRICS_INTERNAL_COUNTER_H
#define IST_SLAM_ROS_METRICS_INTERNAL_COUNTER_H
...
class Counter : public ::ist_slam::metrics::Counter {
 public:
  ...
  ist_slam_ros_msgs::Metric ToRosMessage() {
    ist_slam_ros_msgs::Metric msg = gauge_.ToRosMessage();
    msg.type = ist_slam_ros_msgs::Metric::TYPE_COUNTER;
    return msg;
  }
...
#endif  // IST_SLAM_ROS_METRICS_INTERNAL_COUNTER_H
