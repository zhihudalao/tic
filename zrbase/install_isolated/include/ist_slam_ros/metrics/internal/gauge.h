...
#ifndef IST_SLAM_ROS_METRICS_INTERNAL_GAUGE_H
#define IST_SLAM_ROS_METRICS_INTERNAL_GAUGE_H
...
class Gauge : public ::ist_slam::metrics::Gauge {
 public:
  ...
  ist_slam_ros_msgs::Metric ToRosMessage() {
    ist_slam_ros_msgs::Metric msg;
    msg.type = ist_slam_ros_msgs::Metric::TYPE_GAUGE;
    for (const auto& label : labels_) {
      ist_slam_ros_msgs::MetricLabel label_msg;
...
#endif  // IST_SLAM_ROS_METRICS_INTERNAL_GAUGE_H
