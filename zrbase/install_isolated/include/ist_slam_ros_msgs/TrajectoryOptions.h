// Generated by gencpp from file ist_slam_ros_msgs/TrajectoryOptions.msg
// DO NOT EDIT!


#ifndef IST_SLAM_ROS_MSGS_MESSAGE_TRAJECTORYOPTIONS_H
#define IST_SLAM_ROS_MSGS_MESSAGE_TRAJECTORYOPTIONS_H
...
struct TrajectoryOptions_
{
  ...
  typedef boost::shared_ptr< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> const> ConstPtr;

}; // struct TrajectoryOptions_

typedef ::ist_slam_ros_msgs::TrajectoryOptions_<std::allocator<void> > TrajectoryOptions;

typedef boost::shared_ptr< ::ist_slam_ros_msgs::TrajectoryOptions > TrajectoryOptionsPtr;
typedef boost::shared_ptr< ::ist_slam_ros_msgs::TrajectoryOptions const> TrajectoryOptionsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x7eda9b62c16c18faULL;
  static const uint64_t static_value2 = 0x1563587e73501e47ULL;
};

template<class ContainerAllocator>
struct DataType< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ist_slam_ros_msgs::TrajectoryOptions_<ContainerAllocator>& v)
  {
...
#endif // IST_SLAM_ROS_MSGS_MESSAGE_TRAJECTORYOPTIONS_H
