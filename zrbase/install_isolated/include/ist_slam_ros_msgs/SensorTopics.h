// Generated by gencpp from file ist_slam_ros_msgs/SensorTopics.msg
// DO NOT EDIT!


#ifndef IST_SLAM_ROS_MSGS_MESSAGE_SENSORTOPICS_H
#define IST_SLAM_ROS_MSGS_MESSAGE_SENSORTOPICS_H
...
struct SensorTopics_
{
  ...
  typedef boost::shared_ptr< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> const> ConstPtr;

}; // struct SensorTopics_

typedef ::ist_slam_ros_msgs::SensorTopics_<std::allocator<void> > SensorTopics;

typedef boost::shared_ptr< ::ist_slam_ros_msgs::SensorTopics > SensorTopicsPtr;
typedef boost::shared_ptr< ::ist_slam_ros_msgs::SensorTopics const> SensorTopicsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbafbff7d66e3eeebULL;
  static const uint64_t static_value2 = 0x8d4a9195096cba08ULL;
};

template<class ContainerAllocator>
struct DataType< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ist_slam_ros_msgs::SensorTopics_<ContainerAllocator>& v)
  {
...
#endif // IST_SLAM_ROS_MSGS_MESSAGE_SENSORTOPICS_H
