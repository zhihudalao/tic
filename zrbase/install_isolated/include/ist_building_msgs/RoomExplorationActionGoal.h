// Generated by gencpp from file ist_building_msgs/RoomExplorationActionGoal.msg
// DO NOT EDIT!


#ifndef IST_BUILDING_MSGS_MESSAGE_ROOMEXPLORATIONACTIONGOAL_H
#define IST_BUILDING_MSGS_MESSAGE_ROOMEXPLORATIONACTIONGOAL_H
...
#include <ist_building_msgs/RoomExplorationGoal.h>
...
struct RoomExplorationActionGoal_
{
  ...
  _goal_id_type goal_id;
   ...
   typedef  ::ist_building_msgs::RoomExplorationGoal_<ContainerAllocator>  _goal_type;
  _goal_type goal;
  ...
  typedef boost::shared_ptr< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> const> ConstPtr;

}; // struct RoomExplorationActionGoal_

typedef ::ist_building_msgs::RoomExplorationActionGoal_<std::allocator<void> > RoomExplorationActionGoal;

typedef boost::shared_ptr< ::ist_building_msgs::RoomExplorationActionGoal > RoomExplorationActionGoalPtr;
typedef boost::shared_ptr< ::ist_building_msgs::RoomExplorationActionGoal const> RoomExplorationActionGoalConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "3b0e66d99cdf55073f86079ba0b17995";
  }

  static const char* value(const ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3b0e66d99cdf5507ULL;
  static const uint64_t static_value2 = 0x3f86079ba0b17995ULL;
};

template<class ContainerAllocator>
struct DataType< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ist_building_msgs/RoomExplorationActionGoal";
  }
...
template<class ContainerAllocator>
struct Definition< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ist_building_msgs::RoomExplorationActionGoal_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "goal: ";
    s << std::endl;
    Printer< ::ist_building_msgs::RoomExplorationGoal_<ContainerAllocator> >::stream(s, indent + "  ", v.goal);
  }
};
...
#endif // IST_BUILDING_MSGS_MESSAGE_ROOMEXPLORATIONACTIONGOAL_H
