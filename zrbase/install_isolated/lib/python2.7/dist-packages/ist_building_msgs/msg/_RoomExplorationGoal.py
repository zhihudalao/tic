...
"""autogenerated by genpy from ist_building_msgs/RoomExplorationGoal.msg. Do not edit."""
import sys
...
class RoomExplorationGoal(genpy.Message):
  _md5sum = "3809700d96fa1d88493d9c1b44c54b9c"
  _type = "ist_building_msgs/RoomExplorationGoal"
...
float64 theta
"""
  __slots__ = ['input_map','map_resolution','map_origin','robot_radius','coverage_radius','field_of_view','starting_position','planning_mode','room_order','scale_ratio']
  _slot_types = ['sensor_msgs/Image','float32','geometry_msgs/Pose','float32','float32','geometry_msgs/Point32[]','geometry_msgs/Pose2D','int32','int32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       input_map,map_resolution,map_origin,robot_radius,coverage_radius,field_of_view,starting_position,planning_mode,room_order,scale_ratio
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3d2if().pack(_x.starting_position.x, _x.starting_position.y, _x.starting_position.theta, _x.planning_mode, _x.room_order, _x.scale_ratio))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.starting_position.x, _x.starting_position.y, _x.starting_position.theta, _x.planning_mode, _x.room_order, _x.scale_ratio,) = _get_struct_3d2if().unpack(str[start:end])
      return self
