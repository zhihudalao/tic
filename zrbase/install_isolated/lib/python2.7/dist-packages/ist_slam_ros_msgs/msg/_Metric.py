...
"""autogenerated by genpy from ist_slam_ros_msgs/Metric.msg. Do not edit."""
import sys
...
class Metric(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/Metric"
...
"""
  ...
  _slot_types = ['uint8','ist_slam_ros_msgs/MetricLabel[]','float64','ist_slam_ros_msgs/HistogramBucket[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ist_slam_ros_msgs.msg.MetricLabel()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
      ...
      self.counts_by_bucket = []
      for i in range(0, length):
        val1 = ist_slam_ros_msgs.msg.HistogramBucket()
        _x = val1
        start = end
        end += 16
