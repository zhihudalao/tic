...
"""autogenerated by genpy from ist_slam_ros_msgs/MetricFamily.msg. Do not edit."""
import sys
...
class MetricFamily(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/MetricFamily"
...
"""
  ...
  _slot_types = ['string','string','ist_slam_ros_msgs/Metric[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ist_slam_ros_msgs.msg.Metric()
        start = end
        end += 1
        ...
        val1.labels = []
        for i in range(0, length):
          val2 = ist_slam_ros_msgs.msg.MetricLabel()
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
        ...
        for i in range(0, length):
          val2 = ist_slam_ros_msgs.msg.HistogramBucket()
          _x = val2
          start = end
          end += 16
