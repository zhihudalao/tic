...
"""autogenerated by genpy from ist_slam_ros_msgs/SubmapQueryRequest.msg. Do not edit."""
import sys
...
class SubmapQueryRequest(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/SubmapQueryRequest"
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ist_slam_ros_msgs/SubmapQueryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SubmapQueryResponse(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/SubmapQueryResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['ist_slam_ros_msgs/StatusResponse','int32','ist_slam_ros_msgs/SubmapTexture[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ist_slam_ros_msgs.msg.SubmapTexture()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
...
class SubmapQuery(object):
  _type          = 'ist_slam_ros_msgs/SubmapQuery'
