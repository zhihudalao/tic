...
"""autogenerated by genpy from ist_slam_ros_msgs/GetTrajectoryStatesRequest.msg. Do not edit."""
import sys
...
class GetTrajectoryStatesRequest(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/GetTrajectoryStatesRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ist_slam_ros_msgs/GetTrajectoryStatesResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetTrajectoryStatesResponse(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/GetTrajectoryStatesResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['ist_slam_ros_msgs/StatusResponse','ist_slam_ros_msgs/TrajectoryStates']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.trajectory_states is None:
        self.trajectory_states = ist_slam_ros_msgs.msg.TrajectoryStates()
    else:
      self.status = ist_slam_ros_msgs.msg.StatusResponse()
      self.trajectory_states = ist_slam_ros_msgs.msg.TrajectoryStates()
...
class GetTrajectoryStates(object):
  _type          = 'ist_slam_ros_msgs/GetTrajectoryStates'
  _md5sum = 'b9e3b373f17df088ee6dcd817b79dff0'
