...
"""autogenerated by genpy from ist_slam_ros_msgs/ReadMetricsRequest.msg. Do not edit."""
import sys
...
class ReadMetricsRequest(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/ReadMetricsRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ist_slam_ros_msgs/ReadMetricsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ReadMetricsResponse(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/ReadMetricsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['ist_slam_ros_msgs/StatusResponse','ist_slam_ros_msgs/MetricFamily[]','time']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ist_slam_ros_msgs.msg.MetricFamily()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        val1.metrics = []
        for i in range(0, length):
          val2 = ist_slam_ros_msgs.msg.Metric()
          start = end
          end += 1
          ...
          val2.labels = []
          for i in range(0, length):
            val3 = ist_slam_ros_msgs.msg.MetricLabel()
            start = end
            end += 4
            (length,) = _struct_I.unpack(str[start:end])
            start = end
          ...
          for i in range(0, length):
            val3 = ist_slam_ros_msgs.msg.HistogramBucket()
            _x = val3
            start = end
            end += 16
...
class ReadMetrics(object):
  _type          = 'ist_slam_ros_msgs/ReadMetrics'
  _md5sum = 'a1fe8d7dcf3708e96e015774b1df470e'
