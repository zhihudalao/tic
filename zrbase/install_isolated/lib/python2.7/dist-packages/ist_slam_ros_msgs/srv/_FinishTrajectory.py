...
"""autogenerated by genpy from ist_slam_ros_msgs/FinishTrajectoryRequest.msg. Do not edit."""
import sys
...
class FinishTrajectoryRequest(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/FinishTrajectoryRequest"
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from ist_slam_ros_msgs/FinishTrajectoryResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class FinishTrajectoryResponse(genpy.Message):
  ...
  _type = "ist_slam_ros_msgs/FinishTrajectoryResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  __slots__ = ['status']
  _slot_types = ['ist_slam_ros_msgs/StatusResponse']
...
class FinishTrajectory(object):
  _type          = 'ist_slam_ros_msgs/FinishTrajectory'
