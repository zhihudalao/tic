...
if("FALSE" STREQUAL "TRUE")
  set(navfn_SOURCE_PREFIX /home/ubuntu/zrbase/src/navigation/navfn)
  set(navfn_DEVEL_PREFIX /home/ubuntu/zrbase/devel_isolated/navfn)
  set(navfn_INSTALL_PREFIX "")
  set(navfn_PREFIX ${navfn_DEVEL_PREFIX})
else()
  set(navfn_SOURCE_PREFIX "")
  set(navfn_DEVEL_PREFIX "")
  set(navfn_INSTALL_PREFIX /home/ubuntu/zrbase/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navfn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/zrbase/install_isolated/${idir}'.  ${_report}")
    endif()
