...
class BaseController:
    ...
    def __init__(self, arduino, base_frame):
	    ...
	    self.sonar_pub_cloud = rospy.Publisher("/sonar_cloudpoint", PointCloud2, queue_size = 1)
    ...
    def poll(self):
        ...
        if now > self.t_next:
            ...
            if not self.stopped:
                ...
                #rospy.loginfo("v_left: " + str(self.v_left)+"v_right: " + str(self.v_right))
    ...
    def cmdVelCallback(self, req):
	    ...
	    '''
	    #20170916-chenyf-add
	    if((self.sonar_r2<=self.safe_range_0 and self.sonar_r2>=2))and (x>0.1):
		x=0.0
            '''
	    ...
	    '''
            #20170916-chenyf-add
            if((self.sonar_r3<=self.safe_range_0 and self.sonar_r3>=2))and (x>0.1):
                x=0.0
