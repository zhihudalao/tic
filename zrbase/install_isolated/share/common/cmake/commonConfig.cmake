...
if("FALSE" STREQUAL "TRUE")
  set(common_SOURCE_PREFIX /home/ubuntu/zrbase/src/common)
  set(common_DEVEL_PREFIX /home/ubuntu/zrbase/devel_isolated/common)
  set(common_INSTALL_PREFIX "")
  set(common_PREFIX ${common_DEVEL_PREFIX})
else()
  set(common_SOURCE_PREFIX "")
  set(common_DEVEL_PREFIX "")
  set(common_INSTALL_PREFIX /home/ubuntu/zrbase/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'common' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/zrbase/install_isolated/${idir}'.  ${_report}")
    endif()
