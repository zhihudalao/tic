...
(cl:defclass <StartTrajectory-request> (roslisp-msg-protocol:ros-message)
  ((options
    :reader options
    :initarg :options
    :type ist_slam_ros_msgs-msg:TrajectoryOptions
    :initform (cl:make-instance 'ist_slam_ros_msgs-msg:TrajectoryOptions))
   (topics
    :reader topics
    :initarg :topics
    :type ist_slam_ros_msgs-msg:SensorTopics
    :initform (cl:make-instance 'ist_slam_ros_msgs-msg:SensorTopics)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <StartTrajectory-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartTrajectory-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<StartTrajectory-request> is deprecated: use ist_slam_ros_msgs-srv:StartTrajectory-request instead.")))

(cl:ensure-generic-function 'options-val :lambda-list '(m))
(cl:defmethod options-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:options-val is deprecated.  Use ist_slam_ros_msgs-srv:options instead.")
  (options m))

(cl:ensure-generic-function 'topics-val :lambda-list '(m))
(cl:defmethod topics-val ((m <StartTrajectory-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:topics-val is deprecated.  Use ist_slam_ros_msgs-srv:topics instead.")
  (topics m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartTrajectory-request>)))
  ...
  "ist_slam_ros_msgs/StartTrajectoryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory-request)))
  "Returns string type for a service object of type 'StartTrajectory-request"
  "ist_slam_ros_msgs/StartTrajectoryRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <StartTrajectory-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StartTrajectory-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<StartTrajectory-response> is deprecated: use ist_slam_ros_msgs-srv:StartTrajectory-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StartTrajectory-response>)))
  ...
  "ist_slam_ros_msgs/StartTrajectoryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory-response)))
  "Returns string type for a service object of type 'StartTrajectory-response"
  "ist_slam_ros_msgs/StartTrajectoryResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StartTrajectory-response>)))
  ...
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%int32 trajectory_id~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StartTrajectory-response)))
  "Returns full string definition for message of type 'StartTrajectory-response"
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%int32 trajectory_id~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StartTrajectory)))
  ...
  "ist_slam_ros_msgs/StartTrajectory")