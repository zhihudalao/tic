...
(cl:defmethod cl:initialize-instance :after ((m <GetTrajectoryStates-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTrajectoryStates-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<GetTrajectoryStates-request> is deprecated: use ist_slam_ros_msgs-srv:GetTrajectoryStates-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetTrajectoryStates-request>)))
  ...
  "ist_slam_ros_msgs/GetTrajectoryStatesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTrajectoryStates-request)))
  "Returns string type for a service object of type 'GetTrajectoryStates-request"
  "ist_slam_ros_msgs/GetTrajectoryStatesRequest")
...
(cl:defclass <GetTrajectoryStates-response> (roslisp-msg-protocol:ros-message)
  ((status
   ...
   (trajectory_states
    ...
    :type ist_slam_ros_msgs-msg:TrajectoryStates
    :initform (cl:make-instance 'ist_slam_ros_msgs-msg:TrajectoryStates)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetTrajectoryStates-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetTrajectoryStates-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<GetTrajectoryStates-response> is deprecated: use ist_slam_ros_msgs-srv:GetTrajectoryStates-response instead.")))
...
(cl:defmethod trajectory_states-val ((m <GetTrajectoryStates-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:trajectory_states-val is deprecated.  Use ist_slam_ros_msgs-srv:trajectory_states instead.")
  (trajectory_states m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetTrajectoryStates-response>)))
  ...
  "ist_slam_ros_msgs/GetTrajectoryStatesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTrajectoryStates-response)))
  "Returns string type for a service object of type 'GetTrajectoryStates-response"
  "ist_slam_ros_msgs/GetTrajectoryStatesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetTrajectoryStates)))
  ...
  "ist_slam_ros_msgs/GetTrajectoryStates")