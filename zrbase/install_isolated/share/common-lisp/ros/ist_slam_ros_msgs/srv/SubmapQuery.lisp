...
(cl:defmethod cl:initialize-instance :after ((m <SubmapQuery-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapQuery-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<SubmapQuery-request> is deprecated: use ist_slam_ros_msgs-srv:SubmapQuery-request instead.")))

(cl:ensure-generic-function 'trajectory_id-val :lambda-list '(m))
(cl:defmethod trajectory_id-val ((m <SubmapQuery-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:trajectory_id-val is deprecated.  Use ist_slam_ros_msgs-srv:trajectory_id instead.")
  (trajectory_id m))

(cl:ensure-generic-function 'submap_index-val :lambda-list '(m))
(cl:defmethod submap_index-val ((m <SubmapQuery-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:submap_index-val is deprecated.  Use ist_slam_ros_msgs-srv:submap_index instead.")
  (submap_index m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SubmapQuery-request>)))
  ...
  "ist_slam_ros_msgs/SubmapQueryRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SubmapQuery-request)))
  "Returns string type for a service object of type 'SubmapQuery-request"
  "ist_slam_ros_msgs/SubmapQueryRequest")
...
(cl:defclass <SubmapQuery-response> (roslisp-msg-protocol:ros-message)
  ((status
   ...
   (textures
    :reader textures
    :initarg :textures
    :type (cl:vector ist_slam_ros_msgs-msg:SubmapTexture)
   :initform (cl:make-array 0 :element-type 'ist_slam_ros_msgs-msg:SubmapTexture :initial-element (cl:make-instance 'ist_slam_ros_msgs-msg:SubmapTexture))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SubmapQuery-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapQuery-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<SubmapQuery-response> is deprecated: use ist_slam_ros_msgs-srv:SubmapQuery-response instead.")))
...
(cl:defmethod submap_version-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:submap_version-val is deprecated.  Use ist_slam_ros_msgs-srv:submap_version instead.")
  (submap_version m))

(cl:ensure-generic-function 'textures-val :lambda-list '(m))
(cl:defmethod textures-val ((m <SubmapQuery-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:textures-val is deprecated.  Use ist_slam_ros_msgs-srv:textures instead.")
  (textures m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SubmapQuery-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'textures)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ist_slam_ros_msgs-msg:SubmapTexture))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SubmapQuery-response>)))
  ...
  "ist_slam_ros_msgs/SubmapQueryResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SubmapQuery-response)))
  "Returns string type for a service object of type 'SubmapQuery-response"
  "ist_slam_ros_msgs/SubmapQueryResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SubmapQuery-response>)))
  ...
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%int32 submap_version~%ist_slam_ros_msgs/SubmapTexture[] textures~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%================================================================================~%MSG: ist_slam_ros_msgs/SubmapTexture~%~%uint8[] cells~%int32 width~%int32 height~%float64 resolution~%geometry_msgs/Pose slice_pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SubmapQuery-response)))
  "Returns full string definition for message of type 'SubmapQuery-response"
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%int32 submap_version~%ist_slam_ros_msgs/SubmapTexture[] textures~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%================================================================================~%MSG: ist_slam_ros_msgs/SubmapTexture~%~%uint8[] cells~%int32 width~%int32 height~%float64 resolution~%geometry_msgs/Pose slice_pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
