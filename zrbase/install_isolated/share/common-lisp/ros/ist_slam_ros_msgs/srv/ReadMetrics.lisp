...
(cl:in-package ist_slam_ros_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ReadMetrics-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReadMetrics-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<ReadMetrics-request> is deprecated: use ist_slam_ros_msgs-srv:ReadMetrics-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReadMetrics-request>)))
  ...
  "ist_slam_ros_msgs/ReadMetricsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReadMetrics-request)))
  "Returns string type for a service object of type 'ReadMetrics-request"
  "ist_slam_ros_msgs/ReadMetricsRequest")
...
(cl:defclass <ReadMetrics-response> (roslisp-msg-protocol:ros-message)
  ((status
    :reader status
    :initarg :status
    :type ist_slam_ros_msgs-msg:StatusResponse
    :initform (cl:make-instance 'ist_slam_ros_msgs-msg:StatusResponse))
   (metric_families
    :reader metric_families
    :initarg :metric_families
    :type (cl:vector ist_slam_ros_msgs-msg:MetricFamily)
   :initform (cl:make-array 0 :element-type 'ist_slam_ros_msgs-msg:MetricFamily :initial-element (cl:make-instance 'ist_slam_ros_msgs-msg:MetricFamily)))
   (timestamp
    :reader timestamp
    :initarg :timestamp
    :type cl:real
...
(cl:defmethod cl:initialize-instance :after ((m <ReadMetrics-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReadMetrics-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<ReadMetrics-response> is deprecated: use ist_slam_ros_msgs-srv:ReadMetrics-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <ReadMetrics-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:status-val is deprecated.  Use ist_slam_ros_msgs-srv:status instead.")
  (status m))

(cl:ensure-generic-function 'metric_families-val :lambda-list '(m))
(cl:defmethod metric_families-val ((m <ReadMetrics-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:metric_families-val is deprecated.  Use ist_slam_ros_msgs-srv:metric_families instead.")
  (metric_families m))

(cl:ensure-generic-function 'timestamp-val :lambda-list '(m))
(cl:defmethod timestamp-val ((m <ReadMetrics-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:timestamp-val is deprecated.  Use ist_slam_ros_msgs-srv:timestamp instead.")
  (timestamp m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ReadMetrics-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'metric_families)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ist_slam_ros_msgs-msg:MetricFamily))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReadMetrics-response>)))
  ...
  "ist_slam_ros_msgs/ReadMetricsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReadMetrics-response)))
  "Returns string type for a service object of type 'ReadMetrics-response"
  "ist_slam_ros_msgs/ReadMetricsResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ReadMetrics-response>)))
  ...
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%ist_slam_ros_msgs/MetricFamily[] metric_families~%time timestamp~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%================================================================================~%MSG: ist_slam_ros_msgs/MetricFamily~%~%string name~%string description~%ist_slam_ros_msgs/Metric[] metrics~%~%================================================================================~%MSG: ist_slam_ros_msgs/Metric~%~%uint8 TYPE_COUNTER=0~%uint8 TYPE_GAUGE=1~%uint8 TYPE_HISTOGRAM=2~%~%uint8 type~%ist_slam_ros_msgs/MetricLabel[] labels~%~%# TYPE_COUNTER or TYPE_GAUGE~%float64 value~%~%# TYPE_HISTOGRAM~%ist_slam_ros_msgs/HistogramBucket[] counts_by_bucket~%~%================================================================================~%MSG: ist_slam_ros_msgs/MetricLabel~%~%string key~%string value~%~%================================================================================~%MSG: ist_slam_ros_msgs/HistogramBucket~%~%# A histogram bucket counts values x for which:~%#   previous_boundary < x <= bucket_boundary~%# holds.~%float64 bucket_boundary~%float64 count~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ReadMetrics-response)))
  "Returns full string definition for message of type 'ReadMetrics-response"
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%ist_slam_ros_msgs/MetricFamily[] metric_families~%time timestamp~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%================================================================================~%MSG: ist_slam_ros_msgs/MetricFamily~%~%string name~%string description~%ist_slam_ros_msgs/Metric[] metrics~%~%================================================================================~%MSG: ist_slam_ros_msgs/Metric~%~%uint8 TYPE_COUNTER=0~%uint8 TYPE_GAUGE=1~%uint8 TYPE_HISTOGRAM=2~%~%uint8 type~%ist_slam_ros_msgs/MetricLabel[] labels~%~%# TYPE_COUNTER or TYPE_GAUGE~%float64 value~%~%# TYPE_HISTOGRAM~%ist_slam_ros_msgs/HistogramBucket[] counts_by_bucket~%~%================================================================================~%MSG: ist_slam_ros_msgs/MetricLabel~%~%string key~%string value~%~%================================================================================~%MSG: ist_slam_ros_msgs/HistogramBucket~%~%# A histogram bucket counts values x for which:~%#   previous_boundary < x <= bucket_boundary~%# holds.~%float64 bucket_boundary~%float64 count~%~%~%"))
