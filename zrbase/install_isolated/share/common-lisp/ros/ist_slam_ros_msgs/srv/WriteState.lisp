...
(cl:defmethod cl:initialize-instance :after ((m <WriteState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WriteState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<WriteState-request> is deprecated: use ist_slam_ros_msgs-srv:WriteState-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <WriteState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:filename-val is deprecated.  Use ist_slam_ros_msgs-srv:filename instead.")
  (filename m))
...
(cl:defmethod include_unfinished_submaps-val ((m <WriteState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-srv:include_unfinished_submaps-val is deprecated.  Use ist_slam_ros_msgs-srv:include_unfinished_submaps instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WriteState-request>)))
  ...
  "ist_slam_ros_msgs/WriteStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WriteState-request)))
  "Returns string type for a service object of type 'WriteState-request"
  "ist_slam_ros_msgs/WriteStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <WriteState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WriteState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-srv:<WriteState-response> is deprecated: use ist_slam_ros_msgs-srv:WriteState-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WriteState-response>)))
  ...
  "ist_slam_ros_msgs/WriteStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WriteState-response)))
  "Returns string type for a service object of type 'WriteState-response"
  "ist_slam_ros_msgs/WriteStateResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WriteState-response>)))
  ...
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WriteState-response)))
  "Returns full string definition for message of type 'WriteState-response"
  (cl:format cl:nil "ist_slam_ros_msgs/StatusResponse status~%~%~%================================================================================~%MSG: ist_slam_ros_msgs/StatusResponse~%~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%~%"))
