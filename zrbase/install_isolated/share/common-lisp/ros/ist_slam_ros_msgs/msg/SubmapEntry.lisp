...
(cl:defmethod cl:initialize-instance :after ((m <SubmapEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<SubmapEntry> is deprecated: use ist_slam_ros_msgs-msg:SubmapEntry instead.")))

(cl:ensure-generic-function 'trajectory_id-val :lambda-list '(m))
(cl:defmethod trajectory_id-val ((m <SubmapEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:trajectory_id-val is deprecated.  Use ist_slam_ros_msgs-msg:trajectory_id instead.")
  (trajectory_id m))

(cl:ensure-generic-function 'submap_index-val :lambda-list '(m))
(cl:defmethod submap_index-val ((m <SubmapEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:submap_index-val is deprecated.  Use ist_slam_ros_msgs-msg:submap_index instead.")
  (submap_index m))

(cl:ensure-generic-function 'submap_version-val :lambda-list '(m))
(cl:defmethod submap_version-val ((m <SubmapEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:submap_version-val is deprecated.  Use ist_slam_ros_msgs-msg:submap_version instead.")
  (submap_version m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <SubmapEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:pose-val is deprecated.  Use ist_slam_ros_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'is_frozen-val :lambda-list '(m))
(cl:defmethod is_frozen-val ((m <SubmapEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:is_frozen-val is deprecated.  Use ist_slam_ros_msgs-msg:is_frozen instead.")
  (is_frozen m))
