...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryOptions>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryOptions)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<TrajectoryOptions> is deprecated: use ist_slam_ros_msgs-msg:TrajectoryOptions instead.")))

(cl:ensure-generic-function 'tracking_frame-val :lambda-list '(m))
(cl:defmethod tracking_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:tracking_frame-val is deprecated.  Use ist_slam_ros_msgs-msg:tracking_frame instead.")
  (tracking_frame m))

(cl:ensure-generic-function 'published_frame-val :lambda-list '(m))
(cl:defmethod published_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:published_frame-val is deprecated.  Use ist_slam_ros_msgs-msg:published_frame instead.")
  (published_frame m))

(cl:ensure-generic-function 'odom_frame-val :lambda-list '(m))
(cl:defmethod odom_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:odom_frame-val is deprecated.  Use ist_slam_ros_msgs-msg:odom_frame instead.")
  (odom_frame m))

(cl:ensure-generic-function 'provide_odom_frame-val :lambda-list '(m))
(cl:defmethod provide_odom_frame-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:provide_odom_frame-val is deprecated.  Use ist_slam_ros_msgs-msg:provide_odom_frame instead.")
...
(cl:defmethod use_odometry-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:use_odometry-val is deprecated.  Use ist_slam_ros_msgs-msg:use_odometry instead.")
  (use_odometry m))

(cl:ensure-generic-function 'use_nav_sat-val :lambda-list '(m))
(cl:defmethod use_nav_sat-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:use_nav_sat-val is deprecated.  Use ist_slam_ros_msgs-msg:use_nav_sat instead.")
  (use_nav_sat m))

(cl:ensure-generic-function 'use_landmarks-val :lambda-list '(m))
(cl:defmethod use_landmarks-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:use_landmarks-val is deprecated.  Use ist_slam_ros_msgs-msg:use_landmarks instead.")
  (use_landmarks m))
...
(cl:defmethod publish_frame_projected_to_2d-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:publish_frame_projected_to_2d-val is deprecated.  Use ist_slam_ros_msgs-msg:publish_frame_projected_to_2d instead.")
...
(cl:defmethod num_laser_scans-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:num_laser_scans-val is deprecated.  Use ist_slam_ros_msgs-msg:num_laser_scans instead.")
  (num_laser_scans m))
...
(cl:defmethod num_multi_echo_laser_scans-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:num_multi_echo_laser_scans-val is deprecated.  Use ist_slam_ros_msgs-msg:num_multi_echo_laser_scans instead.")
...
(cl:defmethod num_subdivisions_per_laser_scan-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:num_subdivisions_per_laser_scan-val is deprecated.  Use ist_slam_ros_msgs-msg:num_subdivisions_per_laser_scan instead.")
...
(cl:defmethod num_point_clouds-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:num_point_clouds-val is deprecated.  Use ist_slam_ros_msgs-msg:num_point_clouds instead.")
  (num_point_clouds m))
...
(cl:defmethod rangefinder_sampling_ratio-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:rangefinder_sampling_ratio-val is deprecated.  Use ist_slam_ros_msgs-msg:rangefinder_sampling_ratio instead.")
...
(cl:defmethod odometry_sampling_ratio-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:odometry_sampling_ratio-val is deprecated.  Use ist_slam_ros_msgs-msg:odometry_sampling_ratio instead.")
...
(cl:defmethod fixed_frame_pose_sampling_ratio-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:fixed_frame_pose_sampling_ratio-val is deprecated.  Use ist_slam_ros_msgs-msg:fixed_frame_pose_sampling_ratio instead.")
...
(cl:defmethod imu_sampling_ratio-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:imu_sampling_ratio-val is deprecated.  Use ist_slam_ros_msgs-msg:imu_sampling_ratio instead.")
...
(cl:defmethod landmarks_sampling_ratio-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:landmarks_sampling_ratio-val is deprecated.  Use ist_slam_ros_msgs-msg:landmarks_sampling_ratio instead.")
...
(cl:defmethod trajectory_builder_options_proto-val ((m <TrajectoryOptions>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:trajectory_builder_options_proto-val is deprecated.  Use ist_slam_ros_msgs-msg:trajectory_builder_options_proto instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectoryOptions>)))
  ...
  "ist_slam_ros_msgs/TrajectoryOptions")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectoryOptions)))
  "Returns string type for a message object of type 'TrajectoryOptions"
  "ist_slam_ros_msgs/TrajectoryOptions")
