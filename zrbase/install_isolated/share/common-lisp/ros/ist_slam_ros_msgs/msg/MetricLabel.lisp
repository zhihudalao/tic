...
(cl:defmethod cl:initialize-instance :after ((m <MetricLabel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MetricLabel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<MetricLabel> is deprecated: use ist_slam_ros_msgs-msg:MetricLabel instead.")))

(cl:ensure-generic-function 'key-val :lambda-list '(m))
(cl:defmethod key-val ((m <MetricLabel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:key-val is deprecated.  Use ist_slam_ros_msgs-msg:key instead.")
  (key m))
