...
(cl:defmethod cl:initialize-instance :after ((m <StatusResponse>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StatusResponse)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<StatusResponse> is deprecated: use ist_slam_ros_msgs-msg:StatusResponse instead.")))

(cl:ensure-generic-function 'code-val :lambda-list '(m))
(cl:defmethod code-val ((m <StatusResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:code-val is deprecated.  Use ist_slam_ros_msgs-msg:code instead.")
  (code m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <StatusResponse>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:message-val is deprecated.  Use ist_slam_ros_msgs-msg:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StatusResponse>)))
  ...
  "ist_slam_ros_msgs/StatusResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StatusResponse)))
  "Returns string type for a message object of type 'StatusResponse"
  "ist_slam_ros_msgs/StatusResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<StatusResponse>)))
  ...
  (cl:format cl:nil "~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'StatusResponse)))
  "Returns full string definition for message of type 'StatusResponse"
  (cl:format cl:nil "~%# A common message type to indicate the outcome of a service call.~%uint8 code~%string message~%~%~%"))
