...
(cl:defmethod cl:initialize-instance :after ((m <HistogramBucket>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HistogramBucket)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<HistogramBucket> is deprecated: use ist_slam_ros_msgs-msg:HistogramBucket instead.")))

(cl:ensure-generic-function 'bucket_boundary-val :lambda-list '(m))
(cl:defmethod bucket_boundary-val ((m <HistogramBucket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:bucket_boundary-val is deprecated.  Use ist_slam_ros_msgs-msg:bucket_boundary instead.")
  (bucket_boundary m))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <HistogramBucket>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:count-val is deprecated.  Use ist_slam_ros_msgs-msg:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HistogramBucket>)))
  ...
  "ist_slam_ros_msgs/HistogramBucket")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HistogramBucket)))
  "Returns string type for a message object of type 'HistogramBucket"
  "ist_slam_ros_msgs/HistogramBucket")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HistogramBucket>)))
  ...
  (cl:format cl:nil "~%# A histogram bucket counts values x for which:~%#   previous_boundary < x <= bucket_boundary~%# holds.~%float64 bucket_boundary~%float64 count~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HistogramBucket)))
  "Returns full string definition for message of type 'HistogramBucket"
  (cl:format cl:nil "~%# A histogram bucket counts values x for which:~%#   previous_boundary < x <= bucket_boundary~%# holds.~%float64 bucket_boundary~%float64 count~%~%~%"))
