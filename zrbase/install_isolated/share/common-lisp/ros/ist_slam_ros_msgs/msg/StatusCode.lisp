...
(cl:defmethod cl:initialize-instance :after ((m <StatusCode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StatusCode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<StatusCode> is deprecated: use ist_slam_ros_msgs-msg:StatusCode instead.")))
