...
(cl:defmethod cl:initialize-instance :after ((m <SubmapTexture>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SubmapTexture)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<SubmapTexture> is deprecated: use ist_slam_ros_msgs-msg:SubmapTexture instead.")))

(cl:ensure-generic-function 'cells-val :lambda-list '(m))
(cl:defmethod cells-val ((m <SubmapTexture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:cells-val is deprecated.  Use ist_slam_ros_msgs-msg:cells instead.")
  (cells m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <SubmapTexture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:width-val is deprecated.  Use ist_slam_ros_msgs-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <SubmapTexture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:height-val is deprecated.  Use ist_slam_ros_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'resolution-val :lambda-list '(m))
(cl:defmethod resolution-val ((m <SubmapTexture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:resolution-val is deprecated.  Use ist_slam_ros_msgs-msg:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'slice_pose-val :lambda-list '(m))
(cl:defmethod slice_pose-val ((m <SubmapTexture>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:slice_pose-val is deprecated.  Use ist_slam_ros_msgs-msg:slice_pose instead.")
  (slice_pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SubmapTexture>)))
  ...
  "ist_slam_ros_msgs/SubmapTexture")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SubmapTexture)))
  "Returns string type for a message object of type 'SubmapTexture"
  "ist_slam_ros_msgs/SubmapTexture")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SubmapTexture>)))
  ...
  (cl:format cl:nil "~%uint8[] cells~%int32 width~%int32 height~%float64 resolution~%geometry_msgs/Pose slice_pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SubmapTexture)))
  "Returns full string definition for message of type 'SubmapTexture"
  (cl:format cl:nil "~%uint8[] cells~%int32 width~%int32 height~%float64 resolution~%geometry_msgs/Pose slice_pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
