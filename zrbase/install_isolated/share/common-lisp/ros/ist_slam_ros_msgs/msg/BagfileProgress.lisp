...
(cl:defmethod cl:initialize-instance :after ((m <BagfileProgress>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BagfileProgress)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<BagfileProgress> is deprecated: use ist_slam_ros_msgs-msg:BagfileProgress instead.")))

(cl:ensure-generic-function 'current_bagfile_name-val :lambda-list '(m))
(cl:defmethod current_bagfile_name-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:current_bagfile_name-val is deprecated.  Use ist_slam_ros_msgs-msg:current_bagfile_name instead.")
...
(cl:defmethod current_bagfile_id-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:current_bagfile_id-val is deprecated.  Use ist_slam_ros_msgs-msg:current_bagfile_id instead.")
...
(cl:defmethod total_bagfiles-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:total_bagfiles-val is deprecated.  Use ist_slam_ros_msgs-msg:total_bagfiles instead.")
  (total_bagfiles m))

(cl:ensure-generic-function 'total_messages-val :lambda-list '(m))
(cl:defmethod total_messages-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:total_messages-val is deprecated.  Use ist_slam_ros_msgs-msg:total_messages instead.")
  (total_messages m))

(cl:ensure-generic-function 'processed_messages-val :lambda-list '(m))
(cl:defmethod processed_messages-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:processed_messages-val is deprecated.  Use ist_slam_ros_msgs-msg:processed_messages instead.")
...
(cl:defmethod total_seconds-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:total_seconds-val is deprecated.  Use ist_slam_ros_msgs-msg:total_seconds instead.")
  (total_seconds m))

(cl:ensure-generic-function 'processed_seconds-val :lambda-list '(m))
(cl:defmethod processed_seconds-val ((m <BagfileProgress>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:processed_seconds-val is deprecated.  Use ist_slam_ros_msgs-msg:processed_seconds instead.")
  (processed_seconds m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BagfileProgress>)))
  ...
  "ist_slam_ros_msgs/BagfileProgress")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BagfileProgress)))
  "Returns string type for a message object of type 'BagfileProgress"
  "ist_slam_ros_msgs/BagfileProgress")
