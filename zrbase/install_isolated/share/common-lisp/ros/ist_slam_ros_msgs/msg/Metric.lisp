...
(cl:defclass <Metric> (roslisp-msg-protocol:ros-message)
  ((type
   ...
   (labels
    :reader labels
    :initarg :labels
    :type (cl:vector ist_slam_ros_msgs-msg:MetricLabel)
   :initform (cl:make-array 0 :element-type 'ist_slam_ros_msgs-msg:MetricLabel :initial-element (cl:make-instance 'ist_slam_ros_msgs-msg:MetricLabel)))
   (value
    :reader value
    :initarg :value
    :type cl:float
   ...
   (counts_by_bucket
    ...
    :type (cl:vector ist_slam_ros_msgs-msg:HistogramBucket)
   :initform (cl:make-array 0 :element-type 'ist_slam_ros_msgs-msg:HistogramBucket :initial-element (cl:make-instance 'ist_slam_ros_msgs-msg:HistogramBucket))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Metric>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Metric)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<Metric> is deprecated: use ist_slam_ros_msgs-msg:Metric instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Metric>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:type-val is deprecated.  Use ist_slam_ros_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'labels-val :lambda-list '(m))
(cl:defmethod labels-val ((m <Metric>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:labels-val is deprecated.  Use ist_slam_ros_msgs-msg:labels instead.")
  (labels m))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <Metric>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:value-val is deprecated.  Use ist_slam_ros_msgs-msg:value instead.")
  (value m))

(cl:ensure-generic-function 'counts_by_bucket-val :lambda-list '(m))
(cl:defmethod counts_by_bucket-val ((m <Metric>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:counts_by_bucket-val is deprecated.  Use ist_slam_ros_msgs-msg:counts_by_bucket instead.")
  (counts_by_bucket m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Metric>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'labels)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ist_slam_ros_msgs-msg:MetricLabel))
