...
(cl:defclass <MetricFamily> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (metrics
    :reader metrics
    :initarg :metrics
    :type (cl:vector ist_slam_ros_msgs-msg:Metric)
   :initform (cl:make-array 0 :element-type 'ist_slam_ros_msgs-msg:Metric :initial-element (cl:make-instance 'ist_slam_ros_msgs-msg:Metric))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MetricFamily>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MetricFamily)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<MetricFamily> is deprecated: use ist_slam_ros_msgs-msg:MetricFamily instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <MetricFamily>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:name-val is deprecated.  Use ist_slam_ros_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'description-val :lambda-list '(m))
(cl:defmethod description-val ((m <MetricFamily>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:description-val is deprecated.  Use ist_slam_ros_msgs-msg:description instead.")
  (description m))

(cl:ensure-generic-function 'metrics-val :lambda-list '(m))
(cl:defmethod metrics-val ((m <MetricFamily>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:metrics-val is deprecated.  Use ist_slam_ros_msgs-msg:metrics instead.")
  (metrics m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MetricFamily>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'metrics)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ist_slam_ros_msgs-msg:Metric))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MetricFamily>)))
  ...
  "ist_slam_ros_msgs/MetricFamily")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MetricFamily)))
  "Returns string type for a message object of type 'MetricFamily"
  "ist_slam_ros_msgs/MetricFamily")
