...
(cl:defmethod cl:initialize-instance :after ((m <LandmarkEntry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LandmarkEntry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ist_slam_ros_msgs-msg:<LandmarkEntry> is deprecated: use ist_slam_ros_msgs-msg:LandmarkEntry instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <LandmarkEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:id-val is deprecated.  Use ist_slam_ros_msgs-msg:id instead.")
  (id m))
...
(cl:defmethod tracking_from_landmark_transform-val ((m <LandmarkEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:tracking_from_landmark_transform-val is deprecated.  Use ist_slam_ros_msgs-msg:tracking_from_landmark_transform instead.")
...
(cl:defmethod translation_weight-val ((m <LandmarkEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:translation_weight-val is deprecated.  Use ist_slam_ros_msgs-msg:translation_weight instead.")
...
(cl:defmethod rotation_weight-val ((m <LandmarkEntry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ist_slam_ros_msgs-msg:rotation_weight-val is deprecated.  Use ist_slam_ros_msgs-msg:rotation_weight instead.")
  (rotation_weight m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LandmarkEntry>)))
  ...
  "ist_slam_ros_msgs/LandmarkEntry")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LandmarkEntry)))
  "Returns string type for a message object of type 'LandmarkEntry"
  "ist_slam_ros_msgs/LandmarkEntry")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LandmarkEntry>)))
  ...
  (cl:format cl:nil "~%string id~%geometry_msgs/Pose tracking_from_landmark_transform~%float64 translation_weight~%float64 rotation_weight~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LandmarkEntry)))
  "Returns full string definition for message of type 'LandmarkEntry"
  (cl:format cl:nil "~%string id~%geometry_msgs/Pose tracking_from_landmark_transform~%float64 translation_weight~%float64 rotation_weight~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
