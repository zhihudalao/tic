...
if("FALSE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /home/ubuntu/zrbase/src/navigation/base_local_planner)
  set(base_local_planner_DEVEL_PREFIX /home/ubuntu/zrbase/devel_isolated/base_local_planner)
  ...
  set(base_local_planner_INSTALL_PREFIX /home/ubuntu/zrbase/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/zrbase/install_isolated/${idir}'.  ${_report}")
    endif()
