...
if("FALSE" STREQUAL "TRUE")
  set(yocs_cmd_vel_mux_SOURCE_PREFIX /home/ubuntu/zrbase/src/yujin_ocs/yocs_cmd_vel_mux)
  set(yocs_cmd_vel_mux_DEVEL_PREFIX /home/ubuntu/zrbase/devel_isolated/yocs_cmd_vel_mux)
  ...
  set(yocs_cmd_vel_mux_INSTALL_PREFIX /home/ubuntu/zrbase/install_isolated)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yocs_cmd_vel_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/zrbase/install_isolated/${idir}'.  ${_report}")
    endif()
